...
class CategoriaController extends AppBaseController
{
    ...
    public function store(CreateCategoriaRequest $request)
    {
        ...
        if($request->file('img_principal')){
          $categoria->addMediaFromRequest('img_principal')->toMediaCollection('categoria_principal');
        }

        if($request->file('img_icono')){
          $categoria->addMediaFromRequest('img_icono')->toMediaCollection('categoria_icono');
        }
