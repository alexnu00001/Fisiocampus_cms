...
class CategoriaCongresoDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'categoria_congresos.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\CategoriaCongreso $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CategoriaCongreso $model)
    {
    ...
    {
        return 'categoria_congresos_datatable_' . time();
    }
}
