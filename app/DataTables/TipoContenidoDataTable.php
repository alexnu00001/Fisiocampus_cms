...
class TipoContenidoDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'tipo_contenidos.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\TipoContenido $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TipoContenido $model)
    {
    ...
    {
        return 'tipo_contenidos_datatable_' . time();
    }
}
