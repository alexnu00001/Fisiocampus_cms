...
class OdaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'odas.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Oda $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Oda $model)
    {
