...
class ProfesorDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'profesors.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Profesor $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Profesor $model)
    {
    ...
    {
        return 'profesors_datatable_' . time();
    }
}
