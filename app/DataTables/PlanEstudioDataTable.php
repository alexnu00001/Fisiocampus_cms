...
class PlanEstudioDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'plan_estudios.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\PlanEstudio $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PlanEstudio $model)
    {
    ...
    {
        return 'plan_estudios_datatable_' . time();
    }
}
