...
class TipoProfesorDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'tipo_profesors.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\TipoProfesor $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TipoProfesor $model)
    {
    ...
    {
        return 'tipo_profesors_datatable_' . time();
    }
}
