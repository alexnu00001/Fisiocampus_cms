...
class ModalidadesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'modalidades.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Modalidades $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Modalidades $model)
    {
    ...
    {
        return 'modalidades_datatable_' . time();
    }
}
