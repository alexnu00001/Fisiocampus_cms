...
class TipoOdaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'tipo_odas.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\TipoOda $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TipoOda $model)
    {
    ...
    {
        return 'tipo_odas_datatable_' . time();
    }
}
