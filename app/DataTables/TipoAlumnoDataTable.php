...
class TipoAlumnoDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'tipo_alumnos.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\TipoAlumno $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TipoAlumno $model)
    {
    ...
    {
        return 'tipo_alumnos_datatable_' . time();
    }
}
