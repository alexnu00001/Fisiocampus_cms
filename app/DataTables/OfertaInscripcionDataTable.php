...
class OfertaInscripcionDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'oferta_inscripcions.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\OfertaInscripcion $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(OfertaInscripcion $model)
    {
    ...
    {
        return 'oferta_inscripcions_datatable_' . time();
    }
}
