...
class ControlSuscripcionDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'control_suscripcions.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\ControlSuscripcion $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ControlSuscripcion $model)
    {
    ...
    {
        return 'control_suscripcions_datatable_' . time();
    }
}
