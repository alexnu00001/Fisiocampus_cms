...
class TipoOfertaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'tipo_ofertas.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\TipoOferta $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TipoOferta $model)
    {
    ...
    {
        return 'tipo_ofertas_datatable_' . time();
    }
}
