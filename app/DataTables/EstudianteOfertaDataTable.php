...
class EstudianteOfertaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'estudiante_ofertas.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\EstudianteOferta $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(EstudianteOferta $model)
    {
    ...
    {
        return 'estudiante_ofertas_datatable_' . time();
    }
}
