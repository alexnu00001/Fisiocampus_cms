...
class EstatusDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'estatuses.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Estatus $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Estatus $model)
    {
    ...
    {
        return 'estatuses_datatable_' . time();
    }
}
