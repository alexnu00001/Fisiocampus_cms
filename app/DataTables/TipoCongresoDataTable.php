...
class TipoCongresoDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'tipo_congresos.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\TipoCongreso $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TipoCongreso $model)
    {
    ...
    {
        return 'tipo_congresos_datatable_' . time();
    }
}
