...
class tipo_calificacionDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'tipo_calificacions.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\tipo_calificacion $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(tipo_calificacion $model)
    {
    ...
    {
        return 'tipo_calificacions_datatable_' . time();
    }
}
