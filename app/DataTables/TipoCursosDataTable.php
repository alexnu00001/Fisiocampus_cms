...
class TipoCursosDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'tipo_cursos.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\TipoCursos $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TipoCursos $model)
    {
    ...
    {
        return 'tipo_cursos_datatable_' . time();
    }
}
