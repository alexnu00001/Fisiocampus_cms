(function ($, DataTable) {
    ...
    DataTable.ext.buttons.postExcelVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="fa fa-file-excel-o"></i> ' + dt.i18n('buttons.excel', 'Excel (Sólo columnas visibles)');
        },
    ...
    DataTable.ext.buttons.postCsvVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="fa fa-file-excel-o"></i> ' + dt.i18n('buttons.csv', 'CSV (Sólo columnas Visibles)');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function (dt) {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', 'Restablecer');
        },
    ...
    if (typeof DataTable.ext.buttons.colvis !== 'undefined') {
        $.extend(DataTable.ext.buttons.colvis, {
            text: function (dt) {
                return '<i class="fa fa-eye"></i> ' + dt.i18n('buttons.colvis', 'Ver');
            }
        });
    }
