          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i
              ...
              <div class="search-input">
                ...
                <input class="input" type="text" placeholder="Buscar En FisioAdmin" tabindex="-1"
                  data-search="laravel-search-list" />
              ...
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                <li class="dropdown-menu-header">
                  <div class="dropdown-header m-0 p-2">
                    <h3 class="white">5 Nuevas</h3><span class="grey darken-2">Notificaciones</span>
                  </div>
                </li>
                  ...
                  <a class="d-flex justify-content-between" href="javascript:void(0)">
                    <div class="media d-flex align-items-start">
                      ...
                      <div class="media-body">
                        <h6 class="primary media-heading">Se Registraron 30 Clientes hoy</h6><small class="notification-text">Revisarlo
                          Ahora?</small>
                      </div><small>
                ...
                <li class="dropdown-menu-footer"><a class="dropdown-item p-1 text-center" href="javascript:void(0)">Leer todas las notificaciones</a></li>
              </ul>
            </li>
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
              ...
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('personas.show',Auth::user()->id)}}"><i
                    class="feather icon-user"></i>Editar Perfil</a><a class="dropdown-item" href="app-email"><i
                    class="feather icon-mail"></i> Mi Bandeja de entrada</a><a class="dropdown-item" href="app-todo"><i class="feather icon-check-square"></i> Tareas</a><a
                  class="dropdown-item" href="app-chat"><i class="feather icon-message-square"></i> Chats</a>
                <div class="dropdown-divider"></div><a class="dropdown-item" href="/logout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
